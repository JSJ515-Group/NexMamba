...
def run_isic(
    ckpt_path: str,
    dataset_dir: str = "dataset/isic2018/val",
    output_folder: str = "testing_isic2018",
    num_classes: int = 2,
    img_size: int = 256,
):
...
def main():
    run_isic(
        # ckpt_path="log/msvm-unet-isic2018/checkpoints/epoch=59-val_mean_dice=0.8953.ckpt",
        ckpt_path="log/msvm-unet-isic2018/checkpoints/epoch=29-val_mean_dice=0.8957.ckpt",
        dataset_dir="dataset/isic2018/val",
        output_folder="testing_isic2018",
        num_classes=2,
        img_size=256,
    )
